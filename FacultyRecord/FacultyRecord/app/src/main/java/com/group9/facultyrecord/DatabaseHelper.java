...
public class DatabaseHelper extends SQLiteOpenHelper {
	public static final String DATABASE_NAME = "cargo";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT,ADDRESS TEXT,DEGREE TEXT)");
    }
    ...
    public boolean insertData(String id,String name,String address,String degree) {
        ...
        contentValues.put(COL_4,degree);
